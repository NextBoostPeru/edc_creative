...
const Faqs = () => {
    return (
        <>
            <section className="section section-ten">
                <section className="faq container">
                    <h4 className="title title-faq">
                        <span className="title-white title-white-faq">PREGUNTAS</span>
                    ...
                    <div className="faq-content">
                        <details className="faq__details">
                            ...
                            <p className="faq__answer">
                                ...
                                exclusivos y de alta calidad en el ámbito de Flyers y Motion, lo que
                                te abrirá oportunidades para trabajar con una variedad de clientes,
